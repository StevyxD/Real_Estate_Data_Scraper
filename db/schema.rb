...
ActiveRecord::Schema[8.1].define(version: 2026_06_22_000000) do
  ...
  create_table "documents", force: :cascade do |t|
    ...
    t.boolean "index_ii_fetched", default: false, null: false
    ...
    t.index ["consideration_amount"], name: "index_documents_on_consideration_amount"
    t.index ["doc_number"], name: "index_documents_on_doc_number"
    t.index ["doc_type"], name: "index_documents_on_doc_type"
    t.index ["index_ii_fetched"], name: "index_documents_on_index_ii_fetched"
    t.index ["property_id"], name: "index_documents_on_property_id"
    t.index ["registration_date"], name: "index_documents_on_registration_date"
  end

  create_table "properties", force: :cascade do |t|
    t.integer "attempts", default: 0, null: false
    t.integer "captcha_attempts", default: 0, null: false
    t.datetime "created_at", null: false
    ...
    t.string "tahsil", default: "", null: false
    t.datetime "updated_at", null: false
    t.string "village", null: false
    t.integer "year", null: false
    t.index ["fully_scraped"], name: "index_properties_on_fully_scraped"
    t.index ["next_retry_at"], name: "index_properties_on_next_retry_at"
